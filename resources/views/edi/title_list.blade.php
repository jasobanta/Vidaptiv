    ...
    <x-slot name="header">
        <div class="float-left">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Dashboard > EDI Title List') }}
            </h2>
        </div> 
        <div class="float-right">
            <x-nav-link :href="route('edi-title.add')">
                {{ __('Add New') }}
            </x-nav-link>
        </div> <br/>
    </x-slot>
            ...
            <div class="w-full">
                ...
                <div class="w-full md:w-5/5 xl:w-5/5  mx-auto px-2">
                    <div id='recipients' class="p-4 mt-3 lg:mt-0 rounded shadow bg-white">
                        ...
                        @endif
                        <table id="edititlelist" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-6">
                                                <a href="{{ url('edi-title/edit/'.$row->id) }}">
                                                    <img src="{{ asset('img/edit.svg') }}" class="action_icons" title="edit" alt="edit"/>
                                                </a>
                                            </div>
                                            <div class="col-6">
                                                <a href="{{ url('edi-title/delete/'.$row->id) }}" onclick="return confirm('Are you sure you want to DELETE?')">
...
<script>
    $(document).ready(function () {
        var table = $('#edititlelist').DataTable({
            "stateSave": true,
            //	responsive: true
        })
    });
